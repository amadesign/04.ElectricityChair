//Осъден на смърт на електрически стол, му се дава възможност да се избави. Има два стола един истински и един фалшив. И двама палачи (не са асоциирани към столовете), единия винаги казва истината, другия винаги лъже. Осъдения има право на един въпрос, към един от тях. В зависимост от отговора, ще разбере кой стол кой е.
